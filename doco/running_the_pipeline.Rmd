...
Step 2 (s2_raw_read_QC) and Step 3 (s3_extract_UMI). Each sample requires a separate run of the pipeline. Luckily, in Snakemake we can automate this process by providing a list of sample IDs in the `config.yml` file.
...
[All command line options](https://snakemake.readthedocs.io/en/v7.24.0/executing/cli.html#all-options).
